 ...
 * @method QuestionType setAccessibilityControl(Property\AccessibilityControlProperty $accessibilityControl)
 * @method QuestionType setAccessibilityFeature(Property\AccessibilityFeatureProperty $accessibilityFeature)
 * @method QuestionType setAccessibilityHazard(Property\AccessibilityHazardProperty $accessibilityHazard)
 * @method QuestionType setAccessibilitySummary(Property\AccessibilitySummaryProperty $accessibilitySummary)
 * @method QuestionType setAccountablePerson(Property\AccountablePersonProperty $accountablePerson)
 * @method QuestionType setAdditionalType(Property\AdditionalTypeProperty $additionalType)
 * @method QuestionType setAggregateRating(Property\AggregateRatingProperty $aggregateRating)
 * @method QuestionType setAlternateName(Property\AlternateNameProperty $alternateName)
 * @method QuestionType setAlternativeHeadline(Property\AlternativeHeadlineProperty $alternativeHeadline)
 * @method QuestionType setAssociatedMedia(Property\AssociatedMediaProperty $associatedMedia)
 * @method QuestionType setAudience(Property\AudienceProperty $audience)
 * @method QuestionType setAudio(Property\AudioProperty $audio)
 * @method QuestionType setAuthor(Property\AuthorProperty $author)
 * @method QuestionType setAward(Property\AwardProperty $award)
 * @method QuestionType setCharacter(Property\CharacterProperty $character)
 * @method QuestionType setCitation(Property\CitationProperty $citation)
 * @method QuestionType setComment(Property\CommentProperty $comment)
 * @method QuestionType setCommentCount(Property\CommentCountProperty $commentCount)
 * @method QuestionType setContentLocation(Property\ContentLocationProperty $contentLocation)
 * @method QuestionType setContentRating(Property\ContentRatingProperty $contentRating)
 ...
 * @method QuestionType setDatePublished(Property\DatePublishedProperty $datePublished)
 ...
 * @method QuestionType setHeadline(Property\HeadlineProperty $headline)
 * @method QuestionType setIdentifier(Property\IdentifierProperty $identifier)
 * @method QuestionType setImage(Property\ImageProperty $image)
 * @method QuestionType setInLanguage(Property\InLanguageProperty $inLanguage)
 * @method QuestionType setInteractionStatistic(Property\InteractionStatisticProperty $interactionStatistic)
 * @method QuestionType setInteractivityType(Property\InteractivityTypeProperty $interactivityType)
 * @method QuestionType setIsAccessibleForFree(Property\IsAccessibleForFreeProperty $isAccessibleForFree)
 * @method QuestionType setIsBasedOn(Property\IsBasedOnProperty $isBasedOn)
 * @method QuestionType setIsFamilyFriendly(Property\IsFamilyFriendlyProperty $isFamilyFriendly)
 * @method QuestionType setIsPartOf(Property\IsPartOfProperty $isPartOf)
 * @method QuestionType setKeywords(Property\KeywordsProperty $keywords)
 * @method QuestionType setLearningResourceType(Property\LearningResourceTypeProperty $learningResourceType)
 * @method QuestionType setLicense(Property\LicenseProperty $license)
 * @method QuestionType setLocationCreated(Property\LocationCreatedProperty $locationCreated)
 * @method QuestionType setMainEntity(Property\MainEntityProperty $mainEntity)
 * @method QuestionType setMainEntityOfPage(Property\MainEntityOfPageProperty $mainEntityOfPage)
 * @method QuestionType setMaterial(Property\MaterialProperty $material)
...
class QuestionType extends CreativeWorkType {
	...
	/**
	 * @var Property\AnswerCountProperty
	 */
	private $answerCount;
	 ...
	 * @return QuestionType
	 */
	public function setAcceptedAnswer(Property\AcceptedAnswerProperty $acceptedAnswer) {
	 ...
	 * @return QuestionType
	 */
	public function setAnswerCount(Property\AnswerCountProperty $answerCount) {
